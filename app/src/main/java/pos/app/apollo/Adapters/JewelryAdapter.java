...
public class JewelryAdapter extends RecyclerView.Adapter<JewelryAdapter.ViewHolder> {
    ...
    public JewelryAdapter(Context mBaseContext, Context mApplicationContext, List<ProductModel> productModelList) {
    ...
    @Override
    public JewelryAdapter.ViewHolder onCreateViewHolder(final ViewGroup parent, final int viewType) {
