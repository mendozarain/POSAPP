...
public class ClothesAdapter extends RecyclerView.Adapter<ClothesAdapter.ViewHolder> {
    ...
    public ClothesAdapter(Context mBaseContext, Context mApplicationContext, List<ProductModel> productModelList) {
    ...
    @Override
    public ClothesAdapter.ViewHolder onCreateViewHolder(final ViewGroup parent, final int viewType) {
